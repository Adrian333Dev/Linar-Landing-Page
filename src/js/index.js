...
const featuresSwiper = new Swiper('.swiper', {
  autoHeight: true,
...
function featuresTabs() {
  return {
    ...
    changeTab(tab) {
      ...
      const tabIndex = { tabOne: 0, tabTwo: 1, tabThree: 2 }[tab];
      featuresSwiper.slideTo(tabIndex);
    },
  };
}

Alpine.data('featuresTabs', featuresTabs);
